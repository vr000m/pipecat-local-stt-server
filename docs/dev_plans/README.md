...
| [UDS server-side trust-boundary hardening](20260626-feature-uds-trust-boundary-hardening.md) | Server Transport | 🟦 Implemented on `feature/uds-trust-boundary-hardening` (phases 1–5) — pending Koda checkout coordination + merge |
